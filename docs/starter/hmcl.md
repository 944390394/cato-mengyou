...
::: tip 提示
如果你在使用联机过程中遇到任何问题，请先查阅 [常见问题解答](./hmcldeFAQ.md)，确认你遇到的问题不在此列后，再依照 [报告问题的正确姿势](./baogaowenti.md) 中的要求联系开发者。
:::
...
如需兑换凭证，请查阅 [兑换凭证教程](/mcer/pingzhengjiaocen.md)。**[待补充]**

::: tip 凭证
凭证 是服务端生成的一串字符串，以作客户端进行请求的一个令牌，有了他服务器就知道了你是谁，有什么权限，相当与现在的通行证一样，服务器通过这个判断你是否有权使用桥接服务 
:::
...
也就是说，未使用桥接服务的用户每半个小时会被断开一次。如需长时间保持链接需申请凭证
...
【[这里](https://mcer.cn/?ref=azAtwBwzp)】是 Cato、ioi 的作者  **猫猫**创建的官方社区.
